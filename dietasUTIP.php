...
$pacientes = "SELECT * FROM pacientes WHERE area = 'UTIP' AND statusP = 'Activo'";
        ...
        <main class="main-content">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    ...
                    <form action="datosEtiquetaUTIP2.php" method="post" target="_blank">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="selectPacientes[]" id="selectPacientes" class="form-select" multiple size="7" required>
                    ...
                    <form method="get" action="checkListUTIP.php">
                        <div class="btn-group me-2">
