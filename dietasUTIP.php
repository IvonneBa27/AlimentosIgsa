...
/*$consulta = "SELECT * FROM dietas WHERE area = 'UTIP' AND DATE (Fecha_Hora_Creacion) = '$fechaFiltro' 
ORDER BY ID DESC LIMIT $start_from, $results_per_page";*/

$consulta = "SELECT * FROM dietas p WHERE area = 'UTIP' AND DATE (Fecha_Hora_Creacion) = '$fechaFiltro' 
ORDER BY 
CASE 
...
$pacientes = "SELECT * FROM pacientes WHERE area = 'UTIP'";
...
<body>
    <div class="d-flex">
        ...
        <main class="main-content">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h3 class="h3">DIETAS UTIP</h3>
                <div class="btn-toolbar mb-2 mb-md-0">

                    <form method="GET" action="dietasUTIP.php">
                    ...
                    <form action="">
                        <div class="btn-group me-2">
                            <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href = 'dietasUTIP.php';">
            ...
            <div class="pagination">
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                    ...
                    echo "<li class='page-item $active'><a class='page-link' href='dietasUTIP.php?page=" . $i . "&fechaFiltro=" . $fechaFiltro . "'>" . $i . "</a></li>";
                }
                ?>
            </div>
        ...
        <div class="modal" tabindex="-1" id="ModalImpresora">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="datosEtiquetaUTIP.php" id="formImpresora">
                        <div class="col-sm-6" hidden>
                            <label for="firstName" class="form-label">Fecha y Hora</label>
                            <input type="datetime" id="fechaHoraActual" name="fechaHoraActual" readonly required>
                        </div>
    ...
    <script src="js/dashboardDietasUTIP.js"></script>
    <script src="js/dietasUTIP.js"></script>
    <script type="text/javascript" src="node_modules/jquery/dist/jquery.min.js"></script>
    <script src="js/nota.js"></script>
    <script src="js/impresionUTIP.js"></script>
