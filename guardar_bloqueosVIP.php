...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $query = "SELECT idPaciente, Desayuno FROM dietas WHERE DATE(Fecha_Hora_Creacion) = '$fecha' AND area = 'PRIVADOS'";
...
if (mysqli_num_rows($resultadoVerificar) > 0) {
    ...
    if (mysqli_query($con, $sqlUpdate)) {
        ...
        $update = "INSERT INTO updatedesayunos(ID, idDieta, IdPaciente, fechaHora, Desayuno, area, modificadoPor) 
                   VALUES ('','$idDieta','$idPaciente','$fecha','$desayuno','PRIVADOS','$usuario')";
    ...
    '$observaciones', '$controlTamizaje', 'PRIVADOS', '$vip','$fecha', '$usuario')";
