...
function guardarOActualizarDieta($idPaciente, $datos, $rangoHoraActual)
{
    ...
    if ($query->num_rows > 0) {
        ...
        VALUES ('', '$nombre', '$fechaNacimiento','$idPaciente', '$cama', '$edad', '$diagnosticoMed', '$prescripcionNutri', '$desayuno', '$colMatutina', '$comida', '$colVespertina', '$cena', '$colNocturna', '$observaciones', '$controlTamizaje', 'QUEMADOS', '$vip', '$fechaHoraActual', '$usuario')";
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <select name="cama" id="cama" class="form-control fs-5" required>
                                <?php
                                $sqlCama = "SELECT numero FROM camas WHERE area = 'QUEMADOS'";
