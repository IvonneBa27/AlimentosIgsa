...
$sesionNombre = $sesi['nombre_completo'];   // Reemplaza con el nombre exacto de la columna
    ...
    if ($query->num_rows > 0) {
        ...
        if ($rangoHoraActual == 'Desayuno') {
            $insert = "INSERT INTO updatedesayunos (ID, idDieta, IdPaciente, fechaHora, Desayuno, area, modificadoPor) 
                       VALUES ('', '$idDieta', '$idPaciente', '$fechaHoraActual', '$desayuno', 'LACTANTES', '$usuario')";
            ...
            VALUES ('', '$idDieta', '$idPaciente', '$fechaHoraActual', '$colMatutina', 'LACTANTES', '$usuario')";
            mysqli_query($con, $insert);
            $sqlUpdate = "UPDATE dietas SET Nombre_Paciente = '$nombre', Fecha_Nacimiento_Paciente = '$fechaNacimiento', Cama_Paciente = '$cama', Edad = '$edad', Diag_Med_Nutri = '$diagnosticoMed', Prescripcion = '$prescripcionNutri', Desayuno = '$desayuno', Col_Matutina = '$colMatutina', Comida = '$comida', Col_Vespertina = '$colVespertina', Cena = '$cena', Col_Nocturna = '$colNocturna', Observaciones = '$observaciones', Control_Tamizaje = '$controlTamizaje', privados = '$vip', Fecha_Hora_Creacion = '$fechaHoraActual', Creado_por = '$usuario' WHERE idPaciente = '$idPaciente' AND DATE(Fecha_Hora_Creacion) = '$fechaHoy'";
            mysqli_query($con, $sqlUpdate);
            ...
            $insert = "INSERT INTO updatecomida (ID, idDieta, IdPaciente, fechaHora, Comida, area, modificadoPor) 
                VALUES ('', '$idDieta', '$idPaciente', '$fechaHoraActual', '$comida', 'LACTANTES', '$usuario')";
            mysqli_query($con, $insert);
            $sqlUpdate = "UPDATE dietas SET Nombre_Paciente = '$nombre', Fecha_Nacimiento_Paciente = '$fechaNacimiento', Cama_Paciente = '$cama', Edad = '$edad', Diag_Med_Nutri = '$diagnosticoMed', Prescripcion = '$prescripcionNutri', Desayuno = '$desayuno', Col_Matutina = '$colMatutina', Comida = '$comida', Col_Vespertina = '$colVespertina', Cena = '$cena', Col_Nocturna = '$colNocturna', Observaciones = '$observaciones', Control_Tamizaje = '$controlTamizaje', privados = '$vip', Fecha_Hora_Creacion = '$fechaHoraActual', Creado_por = '$usuario' WHERE idPaciente = '$idPaciente' AND DATE(Fecha_Hora_Creacion) = '$fechaHoy'";
            mysqli_query($con, $sqlUpdate);
            ...
            $insert = "INSERT INTO updatecol_vespertina (ID, idDieta, IdPaciente, fechaHora, Col_Vespertina, area, modificadoPor) 
                VALUES ('', '$idDieta', '$idPaciente', '$fechaHoraActual', '$colVespertina', 'LACTANTES', '$usuario')";
            mysqli_query($con, $insert);
            $sqlUpdate = "UPDATE dietas SET Nombre_Paciente = '$nombre', Fecha_Nacimiento_Paciente = '$fechaNacimiento', Cama_Paciente = '$cama', Edad = '$edad', Diag_Med_Nutri = '$diagnosticoMed', Prescripcion = '$prescripcionNutri', Desayuno = '$desayuno', Col_Matutina = '$colMatutina', Comida = '$comida', Col_Vespertina = '$colVespertina', Cena = '$cena', Col_Nocturna = '$colNocturna', Observaciones = '$observaciones', Control_Tamizaje = '$controlTamizaje', privados = '$vip', Fecha_Hora_Creacion = '$fechaHoraActual', Creado_por = '$usuario' WHERE idPaciente = '$idPaciente' AND DATE(Fecha_Hora_Creacion) = '$fechaHoy'";
            mysqli_query($con, $sqlUpdate);
            ...
            $insert = "INSERT INTO updatecena (ID, idDieta, IdPaciente, fechaHora, Cena, area, modificadoPor) 
                VALUES ('', '$idDieta', '$idPaciente', '$fechaHoraActual', '$cena', 'LACTANTES', '$usuario')";
            mysqli_query($con, $insert);
            $sqlUpdate = "UPDATE dietas SET Nombre_Paciente = '$nombre', Fecha_Nacimiento_Paciente = '$fechaNacimiento', Cama_Paciente = '$cama', Edad = '$edad', Diag_Med_Nutri = '$diagnosticoMed', Prescripcion = '$prescripcionNutri', Desayuno = '$desayuno', Col_Matutina = '$colMatutina', Comida = '$comida', Col_Vespertina = '$colVespertina', Cena = '$cena', Col_Nocturna = '$colNocturna', Observaciones = '$observaciones', Control_Tamizaje = '$controlTamizaje', privados = '$vip', Fecha_Hora_Creacion = '$fechaHoraActual', Creado_por = '$usuario' WHERE idPaciente = '$idPaciente' AND DATE(Fecha_Hora_Creacion) = '$fechaHoy'";
            mysqli_query($con, $sqlUpdate);
            ...
            $insert = "INSERT INTO updatecol_nocturna (ID, idDieta, IdPaciente, fechaHora, Col_Nocturna, area, modificadoPor) 
                VALUES ('', '$idDieta', '$idPaciente', '$fechaHoraActual', '$colNocturna', 'LACTANTES', '$usuario')";
            mysqli_query($con, $insert);
            $sqlUpdate = "UPDATE dietas SET Nombre_Paciente = '$nombre', Fecha_Nacimiento_Paciente = '$fechaNacimiento', Cama_Paciente = '$cama', Edad = '$edad', Diag_Med_Nutri = '$diagnosticoMed', Prescripcion = '$prescripcionNutri', Desayuno = '$desayuno', Col_Matutina = '$colMatutina', Comida = '$comida', Col_Vespertina = '$colVespertina', Cena = '$cena', Col_Nocturna = '$colNocturna', Observaciones = '$observaciones', Control_Tamizaje = '$controlTamizaje', privados = '$vip', Fecha_Hora_Creacion = '$fechaHoraActual', Creado_por = '$usuario' WHERE idPaciente = '$idPaciente' AND DATE(Fecha_Hora_Creacion) = '$fechaHoy'";
            mysqli_query($con, $sqlUpdate);
        }
        ...
        if ($rangoHoraActual == 'Desayuno') {
            ...
            VALUES ('', '$nombre', '$fechaNacimiento','$idPaciente', '$cama', '$edad', '$diagnosticoMed', '$prescripcionNutri', '$desayuno', '', '', '', '', '', '$observaciones', '$controlTamizaje', 'LACTANTES', '$vip', '$fechaHoraActual', '$usuario')";
            ...
            $sqlInsert = "INSERT INTO dietas 
                (ID, Nombre_Paciente, Fecha_Nacimiento_Paciente, idPaciente, Cama_Paciente, Edad, Diag_Med_Nutri, Prescripcion, Desayuno, Col_Matutina, Comida, Col_Vespertina, Cena, Col_Nocturna, Observaciones, Control_Tamizaje, area, privados, Fecha_Hora_Creacion, Creado_por) 
            VALUES ('', '$nombre', '$fechaNacimiento','$idPaciente', '$cama', '$edad', '$diagnosticoMed', '$prescripcionNutri', '', '$colMatutina', '', '', '', '', '$observaciones', '$controlTamizaje', 'LACTANTES', '$vip', '$fechaHoraActual', '$usuario')";
            mysqli_query($con, $sqlInsert);
            ...
            $sqlInsert = "INSERT INTO dietas 
               (ID, Nombre_Paciente, Fecha_Nacimiento_Paciente, idPaciente, Cama_Paciente, Edad, Diag_Med_Nutri, Prescripcion, Desayuno, Col_Matutina, Comida, Col_Vespertina, Cena, Col_Nocturna, Observaciones, Control_Tamizaje, area, privados, Fecha_Hora_Creacion, Creado_por) 
        VALUES ('', '$nombre', '$fechaNacimiento','$idPaciente', '$cama', '$edad', '$diagnosticoMed', '$prescripcionNutri', '', '', '$comida', '', '', '', '$observaciones', '$controlTamizaje', 'LACTANTES', '$vip', '$fechaHoraActual', '$usuario')";
            mysqli_query($con, $sqlInsert);
            ...
            $sqlInsert = "INSERT INTO dietas 
               (ID, Nombre_Paciente, Fecha_Nacimiento_Paciente, idPaciente, Cama_Paciente, Edad, Diag_Med_Nutri, Prescripcion, Desayuno, Col_Matutina, Comida, Col_Vespertina, Cena, Col_Nocturna, Observaciones, Control_Tamizaje, area, privados, Fecha_Hora_Creacion, Creado_por) 
        VALUES ('', '$nombre', '$fechaNacimiento','$idPaciente', '$cama', '$edad', '$diagnosticoMed', '$prescripcionNutri', '', '', '', '$colVespertina', '', '', '$observaciones', '$controlTamizaje', 'LACTANTES', '$vip', '$fechaHoraActual', '$usuario')";
            mysqli_query($con, $sqlInsert);
            ...
            $sqlInsert = "INSERT INTO dietas 
               (ID, Nombre_Paciente, Fecha_Nacimiento_Paciente, idPaciente, Cama_Paciente, Edad, Diag_Med_Nutri, Prescripcion, Desayuno, Col_Matutina, Comida, Col_Vespertina, Cena, Col_Nocturna, Observaciones, Control_Tamizaje, area, privados, Fecha_Hora_Creacion, Creado_por) 
        VALUES ('', '$nombre', '$fechaNacimiento','$idPaciente', '$cama', '$edad', '$diagnosticoMed', '$prescripcionNutri', '', '', '', '', '$cena', '', '$observaciones', '$controlTamizaje', 'LACTANTES', '$vip', '$fechaHoraActual', '$usuario')";
            mysqli_query($con, $sqlInsert);
            ...
            $sqlInsert = "INSERT INTO dietas 
               (ID, Nombre_Paciente, Fecha_Nacimiento_Paciente, idPaciente, Cama_Paciente, Edad, Diag_Med_Nutri, Prescripcion, Desayuno, Col_Matutina, Comida, Col_Vespertina, Cena, Col_Nocturna, Observaciones, Control_Tamizaje, area, privados, Fecha_Hora_Creacion, Creado_por) 
        VALUES ('', '$nombre', '$fechaNacimiento','$idPaciente', '$cama', '$edad', '$diagnosticoMed', '$prescripcionNutri', '', '', '', '', '', '$colNocturna', '$observaciones', '$controlTamizaje', 'LACTANTES', '$vip', '$fechaHoraActual', '$usuario')";
            mysqli_query($con, $sqlInsert);
...
function guardarOActualizarDietaFamiliar($idPacienteF, $datosFamiliar, $rangoHoraActual)
{
    ...
    if ($query->num_rows > 0) {
        ...
        if ($rangoHoraActual == 'Desayuno') {
            $insert = "INSERT INTO updatedesayunos (ID, idDieta, IdPaciente, fechaHora, Desayuno, area, modificadoPor) 
                       VALUES ('', '$idDieta', '$idPacienteF', '$fechaHoraActual', '$desayunoF', 'LACTANTES', '$usuarioF')";
            mysqli_query($con, $insert);
            ...
            // Realizar la consulta correspondiente a Col_Matutina
            $insert = "INSERT INTO updatecol_matutina (ID, idDieta, IdPaciente, fechaHora, Col_Matutina, area, modificadoPor) 
            VALUES ('', '$idDieta', '$idPacienteF', '$fechaHoraActual', '$colMatutinaF', 'LACTANTES', '$usuarioF')";
            mysqli_query($con, $insert);
            $sqlUpdate = "UPDATE dietas SET Nombre_Paciente = '$nombreF', Fecha_Nacimiento_Paciente = '', Cama_Paciente = '$camaF', Edad = '', Diag_Med_Nutri = '', Prescripcion = '', Desayuno = '$desayunoF', Col_Matutina = '$colMatutinaF', Comida = '$comidaF', Col_Vespertina = '$colVespertinaF', Cena = '$cenaF', Col_Nocturna = '$colNocturnaF', Observaciones = '', Control_Tamizaje = '', privados = '', Fecha_Hora_Creacion = '$fechaHoraActual', Creado_por = '$usuarioF' WHERE idPaciente = '$idFamiliar' AND DATE(Fecha_Hora_Creacion) = '$fechaHoy'";
            mysqli_query($con, $sqlUpdate);
        } elseif ($rangoHoraActual == 'Comida') {
            // Realizar la consulta correspondiente a Comida
            $insert = "INSERT INTO updatecomida (ID, idDieta, IdPaciente, fechaHora, Comida, area, modificadoPor) 
                VALUES ('', '$idDieta', '$idPacienteF', '$fechaHoraActual', '$comidaF', 'LACTANTES', '$usuarioF')";
            mysqli_query($con, $insert);
            $sqlUpdate = "UPDATE dietas SET Nombre_Paciente = '$nombreF', Fecha_Nacimiento_Paciente = '', Cama_Paciente = '$camaF', Edad = '', Diag_Med_Nutri = '', Prescripcion = '', Desayuno = '$desayunoF', Col_Matutina = '$colMatutinaF', Comida = '$comidaF', Col_Vespertina = '$colVespertinaF', Cena = '$cenaF', Col_Nocturna = '$colNocturnaF', Observaciones = '', Control_Tamizaje = '', privados = '', Fecha_Hora_Creacion = '$fechaHoraActual', Creado_por = '$usuarioF' WHERE idPaciente = '$idFamiliar' AND DATE(Fecha_Hora_Creacion) = '$fechaHoy'";
            mysqli_query($con, $sqlUpdate);
        } elseif ($rangoHoraActual == 'Col_Vespertina') {
            // Realizar la consulta correspondiente a Col_Vespertina
            $insert = "INSERT INTO updatecol_vespertina (ID, idDieta, IdPaciente, fechaHora, Col_Vespertina, area, modificadoPor) 
                VALUES ('', '$idDieta', '$idPacienteF', '$fechaHoraActual', '$colVespertinaF', 'LACTANTES', '$usuarioF')";
            mysqli_query($con, $insert);
            $sqlUpdate = "UPDATE dietas SET Nombre_Paciente = '$nombreF', Fecha_Nacimiento_Paciente = '', Cama_Paciente = '$camaF', Edad = '', Diag_Med_Nutri = '', Prescripcion = '', Desayuno = '$desayunoF', Col_Matutina = '$colMatutinaF', Comida = '$comidaF', Col_Vespertina = '$colVespertinaF', Cena = '$cenaF', Col_Nocturna = '$colNocturnaF', Observaciones = '', Control_Tamizaje = '', privados = '', Fecha_Hora_Creacion = '$fechaHoraActual', Creado_por = '$usuarioF' WHERE idPaciente = '$idFamiliar' AND DATE(Fecha_Hora_Creacion) = '$fechaHoy'";
            mysqli_query($con, $sqlUpdate);
        } elseif ($rangoHoraActual == 'Cena') {
            // Realizar la consulta correspondiente a Cena
            $insert = "INSERT INTO updatecena (ID, idDieta, IdPaciente, fechaHora, Cena, area, modificadoPor) 
                VALUES ('', '$idDieta', '$idPacienteF', '$fechaHoraActual', '$cenaF', 'LACTANTES', '$usuarioF')";
            mysqli_query($con, $insert);
            $sqlUpdate = "UPDATE dietas SET Nombre_Paciente = '$nombreF', Fecha_Nacimiento_Paciente = '', Cama_Paciente = '$camaF', Edad = '', Diag_Med_Nutri = '', Prescripcion = '', Desayuno = '$desayunoF', Col_Matutina = '$colMatutinaF', Comida = '$comidaF', Col_Vespertina = '$colVespertinaF', Cena = '$cenaF', Col_Nocturna = '$colNocturnaF', Observaciones = '', Control_Tamizaje = '', privados = '', Fecha_Hora_Creacion = '$fechaHoraActual', Creado_por = '$usuarioF' WHERE idPaciente = '$idFamiliar' AND DATE(Fecha_Hora_Creacion) = '$fechaHoy'";
            mysqli_query($con, $sqlUpdate);
        } elseif ($rangoHoraActual == 'Col_Nocturna') {
            // Realizar la consulta correspondiente a Col_Nocturna
            $insert = "INSERT INTO updatecol_nocturna (ID, idDieta, IdPaciente, fechaHora, Col_Nocturna, area, modificadoPor) 
                VALUES ('', '$idDieta', '$idPacienteF', '$fechaHoraActual', '$colNocturnaF', 'LACTANTES', '$usuarioF')";
            mysqli_query($con, $insert);
            $sqlUpdate = "UPDATE dietas SET Nombre_Paciente = '$nombreF', Fecha_Nacimiento_Paciente = '', Cama_Paciente = '$camaF', Edad = '', Diag_Med_Nutri = '', Prescripcion = '', Desayuno = '$desayunoF', Col_Matutina = '$colMatutinaF', Comida = '$comidaF', Col_Vespertina = '$colVespertinaF', Cena = '$cenaF', Col_Nocturna = '$colNocturnaF', Observaciones = '', Control_Tamizaje = '', privados = '', Fecha_Hora_Creacion = '$fechaHoraActual', Creado_por = '$usuarioF' WHERE idPaciente = '$idFamiliar' AND DATE(Fecha_Hora_Creacion) = '$fechaHoy'";
            mysqli_query($con, $sqlUpdate);
        }
        ...
        if ($rangoHoraActual == 'Desayuno') {
            ...
            $sqlInsert = "INSERT INTO dietas 
                (ID, Nombre_Paciente, Fecha_Nacimiento_Paciente, idPaciente, Cama_Paciente, Edad, Diag_Med_Nutri, Prescripcion, Desayuno, Col_Matutina, Comida, Col_Vespertina, Cena, Col_Nocturna, Observaciones, Control_Tamizaje, area, privados, Fecha_Hora_Creacion, Creado_por) 
            VALUES ('', '$nombreF', '','$idPacienteF', '$camaF', '', '', '', '$desayunoF', '', '', '', '', '', '', '', 'LACTANTES', '', '$fechaHoraActual', '$usuarioF')";
            mysqli_query($con, $sqlInsert);
            ...
            $sqlInsert = "INSERT INTO dietas 
                (ID, Nombre_Paciente, Fecha_Nacimiento_Paciente, idPaciente, Cama_Paciente, Edad, Diag_Med_Nutri, Prescripcion, Desayuno, Col_Matutina, Comida, Col_Vespertina, Cena, Col_Nocturna, Observaciones, Control_Tamizaje, area, privados, Fecha_Hora_Creacion, Creado_por) 
            VALUES ('', '$nombreF', '','$idPacienteF', '$camaF', '', '', '', '', '$colMatutinaF', '', '', '', '', '', '', 'LACTANTES', '', '$fechaHoraActual', '$usuarioF')";
            mysqli_query($con, $sqlInsert);
            ...
            $sqlInsert = "INSERT INTO dietas 
               (ID, Nombre_Paciente, Fecha_Nacimiento_Paciente, idPaciente, Cama_Paciente, Edad, Diag_Med_Nutri, Prescripcion, Desayuno, Col_Matutina, Comida, Col_Vespertina, Cena, Col_Nocturna, Observaciones, Control_Tamizaje, area, privados, Fecha_Hora_Creacion, Creado_por) 
        VALUES ('', '$nombreF', '','$idPacienteF', '', '', '', '', '', '', '$comidaF', '', '', '', '', '', 'LACTANTES', '', '$fechaHoraActual', '$usuarioF')";
            mysqli_query($con, $sqlInsert);
            ...
            $sqlInsert = "INSERT INTO dietas 
               (ID, Nombre_Paciente, Fecha_Nacimiento_Paciente, idPaciente, Cama_Paciente, Edad, Diag_Med_Nutri, Prescripcion, Desayuno, Col_Matutina, Comida, Col_Vespertina, Cena, Col_Nocturna, Observaciones, Control_Tamizaje, area, privados, Fecha_Hora_Creacion, Creado_por) 
        VALUES ('', '$nombreF', '','$idPacienteF', '$camaF', '', '', '', '', '', '', '$colVespertinaF', '', '', '', '', 'LACTANTES', '', '$fechaHoraActual', '$usuarioF')";
            mysqli_query($con, $sqlInsert);
            ...
            $sqlInsert = "INSERT INTO dietas 
               (ID, Nombre_Paciente, Fecha_Nacimiento_Paciente, idPaciente, Cama_Paciente, Edad, Diag_Med_Nutri, Prescripcion, Desayuno, Col_Matutina, Comida, Col_Vespertina, Cena, Col_Nocturna, Observaciones, Control_Tamizaje, area, privados, Fecha_Hora_Creacion, Creado_por) 
        VALUES ('', '$nombreF', '','$idPacienteF', '$camaF', '', '', '', '', '', '', '', '$cenaF', '', '', '', 'LACTANTES', '', '$fechaHoraActual', '$usuarioF')";
            mysqli_query($con, $sqlInsert);
            ...
            $sqlInsert = "INSERT INTO dietas 
               (ID, Nombre_Paciente, Fecha_Nacimiento_Paciente, idPaciente, Cama_Paciente, Edad, Diag_Med_Nutri, Prescripcion, Desayuno, Col_Matutina, Comida, Col_Vespertina, Cena, Col_Nocturna, Observaciones, Control_Tamizaje, area, privados, Fecha_Hora_Creacion, Creado_por) 
        VALUES ('', '$nombreF', '','$idPacienteF', '$camaF', '', '', '', '', '', '', '', '', '$colNocturnaF', '', '', 'LACTANTES', '', '$fechaHoraActual', '$usuarioF')";
            mysqli_query($con, $sqlInsert);
...
LEFT JOIN (
    ...
    INNER JOIN (
        ...
        FROM dietas
        WHERE area = 'LACTANTES' AND DATE(Fecha_Hora_Creacion) = '$fechaHoraActual1'
        GROUP BY idPaciente
    ) d2 ON d1.ID = d2.ID 
) d ON p.idPaciente = d.idPaciente
WHERE p.statusP = 'Activo' AND p.area = 'LACTANTES' 
ORDER BY 
CASE 
...
<body>
        ...
        <main class="main-content d-flex flex-column vh-100">
            ...
            <div class=" encabezado-fijo bg-white border-bottom px-4 pt-3 pb-2" style="position: sticky; top: 0; z-index: 10;">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h3 class="h3">SOLICITUD DE ORDEN LACTANTES</h3>
                    <div class="btn-toolbar mb-2 mb-md-0">


                        <form method="post" action="pdfL.php" target="_blank">
                        ...
                        <form action="">
                            <div class="btn-group me-2">
                                <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href = 'formL.php';">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center" data-campo="edadMeses"><?php echo $dataRow["edadMeses"]; ?></td>
                                                <td class="text-center" data-campo="edadDias"><?php echo $dataRow["edadDias"]; ?></td>
                                                ...
                                                <td class="text-center" data-campo="Desayuno"><textarea class="form-control-plaintext table-textarea" style="" data-campo="Desayuno" disabled><?php echo $dataRow["Desayuno"]; ?></textarea></td>
    ...
    <script src="js/relojL.js"></script>
