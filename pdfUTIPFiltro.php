...
/*$consulta = "SELECT * FROM dietas WHERE (area = 'UTIP' OR privados = 'APLICA') AND DATE(Fecha_Hora_Creacion) = '$fechaFiltro' ORDER BY ID DESC";*/
$consulta = "SELECT * FROM dietas WHERE area = 'UTIP' AND DATE(Fecha_Hora_Creacion) = '$fechaFiltro' ORDER BY ID DESC";
