...
$consulta = "SELECT * FROM dietas p WHERE area = 'LACTANTES' AND DATE (Fecha_Hora_Creacion) = '$fechaFiltro' 
ORDER BY 
  CASE 
...
<body>
  <div class="d-flex">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h3 class="h3">LACTANTES</h3>
      <div class="btn-toolbar mb-2 mb-md-0">

        <form method="GET" action="ordenesL.php">
        ...
        <form action="">
          <div class="btn-group me-2">
            <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href = 'ordenesL.php';">
    ...
    <div class="pagination">
      ...
      for ($i = 1; $i <= $total_pages; $i++) {
        ...
        echo "<li class='page-item $active'><a class='page-link' href='ordenesL.php?page=" . $i . "&fechaFiltro=" . $fechaFiltro . "'>" . $i . "</a></li>";
      }
      ?>
  ...
  <script src="js/dashboardL.js"></script>
