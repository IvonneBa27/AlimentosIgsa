...
/*$consulta = "SELECT * FROM dietas WHERE (area = 'MEDICINA INTERNA' OR privados = 'APLICA') AND DATE(Fecha_Hora_Creacion) = '$fechaFiltro' ORDER BY ID DESC";*/
$consulta = "SELECT * FROM dietas WHERE area = 'MEDICINA INTERNA' AND DATE(Fecha_Hora_Creacion) = '$fechaFiltro' ORDER BY ID DESC";
