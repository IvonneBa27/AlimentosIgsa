    ...
    <div class="d-flex">
        ...
        <main class="main-content">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h3 class="h2">CIERRE DE CAJA</h3>
                <div class="btn-toolbar mb-2 mb-md-0">

                    <form action="">
                        <div class="btn-group me-2">
                            <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href = 'operacionCierreCaja.php';">
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    <?php if ($cajaHoy): ?>
                        ...
                        <p><strong>Hora de Cierre:</strong> <?= htmlspecialchars($cajaHoy['hora_cierre']) ?></p>
                        <p><strong>Monto de Cierre:</strong> $<?= number_format($cajaHoy['monto_cierre'], 2) ?></p>
                        <p><strong>Estatus:</strong>
                            <span class="badge bg-<?= $cajaHoy['estatus'] == 'CERRADA' ? 'warning' : 'secondary' ?>">
