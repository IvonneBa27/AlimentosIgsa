...
/*$consulta = "SELECT * FROM dietas WHERE (area = 'GINECOLOGÍA' OR privados = 'APLICA') AND DATE(Fecha_Hora_Creacion) = '$fechaFiltro' ORDER BY ID DESC";*/
$consulta = "SELECT * FROM dietas WHERE area = 'GINECOLOGÍA' AND DATE(Fecha_Hora_Creacion) = '$fechaFiltro' ORDER BY ID DESC";
