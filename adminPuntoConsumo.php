            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    ...
                    <div class="btn-group me-2">
                        <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#createConsumoModal" onclick="location.href = '#';"><i class="bi bi-person-plus"></i> Agregar Consumo</button>
                    </div>
            ...
            <div class="table-responsive" style="max-height: 830px; overflow-y: auto;">
                <table class="table table-striped">
                    ...
                    <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <a href="#"
                                            ...
                                            data-costo="<?= htmlspecialchars($consumo['costo']) ?>"
                                            data-toggle="modal"
                                            data-target="#editConsumoModal">
                                        ...
                                        <a href="#"
                                            ...
                                            data-bs-target="#deleteConsumoModal"
                                            onclick="setUserId(<?= htmlspecialchars($consumo['id']) ?>)">
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="4">No se encontraron los productos.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="createProductModalLabel">Crear Consumo</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="producto" class="control-label">Consumo *</label>
