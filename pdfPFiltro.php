...
/*$consulta = "SELECT * FROM dietas WHERE (area = 'PEDIATRÍA' OR privados = 'APLICA') AND DATE(Fecha_Hora_Creacion) = '$fechaFiltro' ORDER BY ID DESC";*/
$consulta = "SELECT * FROM dietas WHERE area = 'PEDIATRÍA' AND DATE(Fecha_Hora_Creacion) = '$fechaFiltro' ORDER BY ID DESC";
