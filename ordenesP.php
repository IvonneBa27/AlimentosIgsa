...
/*$total_query = "SELECT COUNT(*) AS total FROM dietas WHERE (area = 'PEDIATRÍA' OR area = 'Privados') AND DATE(Fecha_Hora_Creacion) = '$fechaFiltro'";*/
$total_query = "SELECT COUNT(*) AS total FROM dietas WHERE area = 'PEDIATRÍA' AND DATE(Fecha_Hora_Creacion) = '$fechaFiltro'";
...
/*$consulta = "SELECT * FROM dietas WHERE (area = 'PEDIATRÍA' OR area = 'Privados') AND DATE (Fecha_Hora_Creacion) = '$fechaFiltro' ORDER BY ID DESC LIMIT $start_from, $results_per_page";*/
$consulta = "SELECT * FROM dietas WHERE area = 'PEDIATRÍA' AND DATE (Fecha_Hora_Creacion) = '$fechaFiltro' ORDER BY ID DESC LIMIT $start_from, $results_per_page";
...
<body>
  <div class="d-flex">
    ...
    <main class="main-content">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h3 class="h3">PEDIATRÍA</h3>
        <div class="btn-toolbar mb-2 mb-md-0">

          <form method="GET" action="ordenesP.php">
          ...
          <form method="GET" action="pdfPFiltro.php" target="_blank">
            <div class="btn-group me-2">
          ...
          <form action="">
            <div class="btn-group me-2">
              <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href = 'ordenesP.php';">
      ...
      <div class="pagination">
        ...
        for ($i = 1; $i <= $total_pages; $i++) {
          ...
          echo "<li class='page-item $active'><a class='page-link' href='ordenesP.php?page=" . $i . "&fechaFiltro=" . $fechaFiltro . "'>" . $i . "</a></li>";
        }
        ?>
  ...
  <script src="js/dashboardP.js"></script>
