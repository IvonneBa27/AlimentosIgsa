...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($id) && !empty($nombre)) {
        try {
            ...
            if ($stmt) {
                ...
                if ($stmt->execute()) {
                    $_SESSION['message'] = "Establecimiento actualizada con éxito.";
                    $_SESSION['message_type'] = "success";
                } else {
                    $_SESSION['message'] = "Error al actualizar el establecimiento: " . $stmt->error;
    ...
    header('Location:adminTiendas.php');
    exit();
}
?>
