...
ORDER BY CAST(p.Cama_Paciente AS UNSIGNED) ASC
...
<body>
    <div class="d-flex">
        ...
        <main class="main-content">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h3 class="h3">DIETAS PRIVADOS</h3>
                <div class="btn-toolbar mb-2 mb-md-0">

                    <form method="GET" action="dietasVIP.php">
                    ...
                    <form method="GET" action="pdfVIPFiltro.php" target="_blank">
                        <div class="btn-group me-2">
                    ...
                    <form action="datosEtiquetaVIP2.php" method="post" target="_blank">
                    ...
                    <form method="get" action="checkListVIP.php">
                        <div class="btn-group me-2">
    ...
    <script src="js/dashboardDietasVIP.js"></script>
    <script src="js/dietasVIP.js"></script>
    <script type="text/javascript" src="node_modules/jquery/dist/jquery.min.js"></script>
    <script src="js/nota.js"></script>
    <script src="js/impresionVIP.js"></script>
