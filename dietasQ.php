...
<body>
    <div class="d-flex">
        ...
        <main class="main-content">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h3 class="h3">DIETAS QUEMADOS</h3>
                <div class="btn-toolbar mb-2 mb-md-0">

                    <form method="GET" action="dietasQ.php">
            ...
            <div class="pagination">
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                    ...
                    echo "<li class='page-item $active'><a class='page-link' href='dietasQ.php?page=" . $i . "&fechaFiltro=" . $fechaFiltro . "'>" . $i . "</a></li>";
                }
                ?>
            </div>
    ...
    <script src="js/dashboardDietasQ.js"></script>
