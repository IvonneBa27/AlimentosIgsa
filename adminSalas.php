...
$sql = "SELECT sal.id, sal.nombre, cs.status, emp.nombre as empresa
        FROM salas_conferencias sal
        INNER JOIN catalog_status cs ON cs.status_id = sal.estatus_id
        INNER JOIN empresa emp ON sal.empresa_id = emp.id
        ORDER BY sal.id";
...
<body>
    <div class="d-flex">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h3 class="h3">SALAS DE CONFERENCIA</h3>
            <div class="btn-toolbar mb-2 mb-md-0">

                <div class="btn-group me-2">
                    <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#createSalaModal" onclick="location.href = '#';"><i class="bi bi-person-plus"></i> Agregar Sala de Conferencia</button>
                </div>
                    ...
                    <?php if (!empty($salas)) : ?>
                        <?php foreach ($salas as $sala) : ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($sala['empresa']) ?></td>
                                <td>
                                    <?php if ($sala['status'] === 'ACTIVO'): ?>
                                        <span class="badge bg-success">ACTIVO</span>
                                    <?php elseif ($sala['status'] === 'BAJA'): ?>
                                        <span class="badge bg-danger">BAJA</span>
                                    <?php else: ?>
                                        <span class="badge bg-secondary"><?= htmlspecialchars($sala['status']) ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="actions">
                                    ...
                                    <a href="#"
                                        data-id="<?= htmlspecialchars($sala['id']) ?>"
                                        data-nombre="<?= htmlspecialchars($sala['nombre']) ?>"
                                        data-toggle="modal"
                                        data-target="#editSalaModal">
                                    ...
                                    <a href="#"
                                        ...
                                        data-bs-target="#deleteSalaModal"
                                        onclick="setUserId(<?= htmlspecialchars($sala['id']) ?>)">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="createSalaModalLabel">Crear Sala de Conferencia</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="insert_sala.php" method="POST" enctype="multipart/form-data">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="nombre" class="control-label">Sala de Conferencia *</label>
                                                <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Nombre de la Sala de Conferencia" required style="text-transform:uppercase;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="editSalaModal" tabindex="-1" aria-labelledby="editDepartmentModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editSalaModalLabel">Editar Sala de Conferencia</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="update_sala.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="editNombre" class="control-label">Sala *</label>
        ...
        <div class="modal fade" id="deleteSalaModal" tabindex="-1" aria-labelledby="deleteSalaModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteSalaModalLabel">Confirmación de Baja</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ¿Estás seguro de que deseas dar de baja la Sala de Conferencia?
                    </div>
                    <div class="modal-footer">
                        <form action="delete_sala.php" method="POST">
