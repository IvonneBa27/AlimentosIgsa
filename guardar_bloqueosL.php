...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $query = "SELECT idPaciente, Desayuno FROM dietas WHERE DATE(Fecha_Hora_Creacion) = '$fecha' AND area = 'LACTANTES'";
...
if (mysqli_num_rows($resultadoVerificar) > 0) {
    ...
    if (mysqli_query($con, $sqlUpdate)) {
        ...
        $update = "INSERT INTO updatedesayunos(ID, idDieta, IdPaciente, fechaHora, Desayuno, area, modificadoPor) 
                   VALUES ('','$idDieta','$idPaciente','$fecha','$desayuno','LACTANTES','$usuario')";
    ...
    '$observaciones', '$controlTamizaje', 'LACTANTES', '$vip','$fecha', '$usuario')";
