...
$total_query = "SELECT COUNT(*) AS total FROM dietas WHERE area = 'GINECOLOGÍA' AND DATE(Fecha_Hora_Creacion) = '$fechaFiltro'";
...
$pacientes = "SELECT * FROM pacientes WHERE area = 'GINECOLOGÍA' AND statusP = 'Activo'";
...
<body>
    <div class="d-flex">
        ...
        <main class="main-content">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h3 class="h3">DIETAS GINECOLOGÍA</h3>
                <div class="btn-toolbar mb-2 mb-md-0">

                    <form method="GET" action="dietasG.php">
                    ...
                    <form method="GET" action="pdfGFiltro.php" target="_blank">
                        <div class="btn-group me-2">
                    ...
                    <form action="datosEtiquetaG2.php" method="post" target="_blank">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="selectPacientes[]" id="selectPacientes" class="form-select" multiple size="11" required>
                    ...
                    <form method="get" action="checkListG.php">
                        <div class="btn-group me-2">
                    ...
                    <form action="">
                        <div class="btn-group me-2">
                            <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href = 'dietasG.php';">
            ...
            <div class="pagination">
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                    ...
                    echo "<li class='page-item $active'><a class='page-link' href='dietasG.php?page=" . $i . "&fechaFiltro=" . $fechaFiltro . "'>" . $i . "</a></li>";
                }
                ?>
            </div>
    ...
    <script src="js/dashboardDietasG.js"></script>
    <script src="js/dietasG.js"></script>
    <script type="text/javascript" src="node_modules/jquery/dist/jquery.min.js"></script>
    <script src="js/nota.js"></script>
    <script src="js/impresionG.js"></script>
